...
public class TypeMore implements ActiveEditorDrop {

    private String text = "Enter text here";
    private String elementType = "small";
    ...
    public String generateBody() {
        ...
        code.append("<").append(elementType);                  // Generates <h1
        ...
        code.append(text);
        code.append("</").append(elementType).append(">\n");   //Generates </h1>
    ...
    public boolean handleTransfer(JTextComponent targetComponent) {
        TypeMoreCustomizer c = new TypeMoreCustomizer(this);
